...
Preview: https://files.catbox.moe/rvd432.mp4
...
2. Copy the ```elixir_redzones``` folder to your ```resources``` directory.
3. Add ```ensure elixir_redzones``` to your server.cfg.
...
2. Start the script, and the elixir_redzones will display automatically during gameplay
